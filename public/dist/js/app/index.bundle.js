...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "759c78615c11d03d1824";
...
/******/ 	__webpack_require__.p = "/Users/shouweiliu/Documents/resume/public/dist/assets";
/******/
/******/ 	// __webpack_hash__
...
var _TweenMax = __webpack_require__(/*! TweenMax */ "../../node_modules/gsap/umd/TweenMax.js");
...
__webpack_require__(/*! debug.addIndicators */ "../../node_modules/scrollmagic/scrollmagic/uncompressed/plugins/debug.addIndicators.js");
...
window.controller = new _ScrollMagic2.default.Controller();

window.controller_leave = new _ScrollMagic2.default.Controller({
    globalSceneOptions: {
        triggerHook: 'onLeave'
    }
});

window.controller_enter = new _ScrollMagic2.default.Controller({
    globalSceneOptions: {
        triggerHook: 'onEnter'
    }
});
...
var Page = new _vue2.default({
    ...
    methods: {
        ...
        navBarClick: function navBarClick() {
            var that = this;
            (0, _jquery2.default)(window).bind("scroll resize", function () {
                var scrollTop = (0, _jquery2.default)(window).scrollTop() + 10;
                var sceneBox = (0, _jquery2.default)(".pp-scene-box");
                var navRel = "";
                for (var i = 0; i < sceneBox.length; i++) {
                    var top = sceneBox.eq(i).offset().top;
                    var bottom = top + sceneBox.eq(i).outerHeight();
                ...
                (0, _jquery2.default)(".nav-bar ul li").removeClass("active");
                (0, _jquery2.default)(".nav-bar ul li[rel='" + navRel + "']").addClass("active");

                switch (navRel) {
                    case "example":
                        (0, _jquery2.default)(".nav-bar").addClass("orange-bg");
                        break;
                    default:
                        (0, _jquery2.default)(".nav-bar").removeClass("orange-bg");
                        break;
                }
            }).trigger("scroll");

            (0, _jquery2.default)(".nav-bar ul li").bind("click", function () {
                var navRel = (0, _jquery2.default)(this).attr("rel");
                if ((0, _jquery2.default)(".pp-scene-box[nav-rel='" + navRel + "']").length > 0) {
                    var top = (0, _jquery2.default)(".pp-scene-box[nav-rel='" + navRel + "']").eq(0).offset().top;
                    (0, _jquery2.default)("body, html").stop().animate({ scrollTop: top }, 500, 'swing');
                }
            });
        }
    },
    ...
    computed: _extends({}, (0, _vuex.mapGetters)(["windowSize", "creatorList", "isMobile"])),
    components: {
        SenceGroup_1_2: SenceGroup_1_2,
        SenceGroup_3_4: SenceGroup_3_4,
        Scene5: Scene5,
        Scene6: Scene6,
        Scene7: Scene7,
        Scene8: Scene8
    ...
    run: function run(_run, method, params) {
        ...
        switch (method.toUpperCase()) {
            case "GET":
                ...
                // }
                axPromise = _axios2.default.get(_run, config);
                break;
            case "POST":
                axPromise = _axios2.default.post(_run, params, config);
                break;
            case "PUT":
                axPromise = _axios2.default.put(_run, params, config);
                break;
            case "PATCH":
                axPromise = _axios2.default.patch(_run, params, config);
                break;
            case "DELETE":
                axPromise = _axios2.default.delete(_run, config);
                break;
            default:
...
var _baseApi = __webpack_require__(/*! ../baseApi */ "./lib/api/baseApi.js");

var _baseApi2 = _interopRequireDefault(_baseApi);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var main = _extends({}, _baseApi2.default, {
...
var _index = __webpack_require__(/*! lib/api/common/index */ "./lib/api/common/index.js");
...
exports.default = {
    test: function test(_ref, params) {
        var commit = _ref.commit;

        commit("test", params);
    },
    setWindowSize: function setWindowSize(_ref2, params) {
...
exports.default = {
    ...
    mobileWidth: function mobileWidth(state) {
...
exports.default = {
    setWindowSize: function setWindowSize(state, params) {
        var windowSize = JSON.parse(JSON.stringify(state.windowSize));
        state.windowSize = _extends({}, windowSize, params);
...
exports.default = {
    ...
    creatorList: [{
        title: "尼克",
        img: "./dist/img/creator/尼克.png"
    }, {
        title: "董仔",
        img: "./dist/img/creator/董仔.png"
    }, {
        title: "木星",
        img: "./dist/img/creator/木星.png"
    }, {
        title: "啾啾鞋",
        img: "./dist/img/creator/啾啾鞋.png"
    }, {
        title: "嘟嘟",
        img: "./dist/img/creator/嘟嘟.png"
    }, {
        title: "千千",
        img: "./dist/img/creator/千千.png"
    }, {
        title: "大謙",
        img: "./dist/img/creator/大謙.png"
    }, {
        title: "查理",
        img: "./dist/img/creator/查理.png"
    }, {
        title: "金針菇",
        img: "./dist/img/creator/金針菇.png"
    }, {
        title: "亞歷三小",
        img: "./dist/img/creator/亞歷三小.png"
    }, {
        title: "阿滴英文",
        img: "./dist/img/creator/阿滴英文.png"
    }, {
        title: "MEG",
        img: "./dist/img/creator/MEG.png"
    }, {
        title: "劉力穎",
        img: "./dist/img/creator/劉力穎.png"
    }, {
        title: "阿心",
        img: "./dist/img/creator/阿心.png"
    }, {
        title: "Mira",
        img: "./dist/img/creator/Mira.png"
    }, {
        title: "Julia",
        img: "./dist/img/creator/Julia.png"
    }, {
        title: "阿翰",
        img: "./dist/img/creator/阿翰.png"
    }, {
        title: "異鄉人",
        img: "./dist/img/creator/異鄉人.png"
    }, {
        title: "彼得爸與蘇珊媽",
        img: "./dist/img/creator/彼得爸與蘇珊媽.png"
    }, {
        title: "我是老爸",
        img: "./dist/img/creator/我是老爸.png"
    }, {
        title: "古娃娃",
        img: "./dist/img/creator/古娃娃.png"
    }, {
        title: "愛莉莎莎",
        img: "./dist/img/creator/愛莉莎莎.png"
    },
    // {
    //     title: "Fiti",
    //     img: "./dist/img/creator/fiti.png",
    // },
    {
        title: "海恩奶油",
        img: "./dist/img/creator/海恩奶油.png"
    }, {
        title: "老王",
        img: "./dist/img/creator/老王.png"
    }, {
        title: "林育聖",
        img: "./dist/img/creator/林育聖.png"
    }, {
        title: "游舒帆",
        img: "./dist/img/creator/游舒帆.png"
    }, {
        title: "王伯達",
        img: "./dist/img/creator/王伯達.png"
    }, {
        title: "好倫",
        img: "./dist/img/creator/好倫.png"
    }, {
        title: "六指淵",
        img: "./dist/img/creator/六指淵.png"
    }]
};
...
module.exports = __webpack_require__(/*! /Users/shouweiliu/Documents/resume/src/js/app/index.js */"./app/index.js");
